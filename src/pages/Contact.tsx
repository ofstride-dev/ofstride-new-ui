          ...
          <div className="container-page">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg text-slate-300">
                Book a call directly or send us a message — we'll respond within 24 hours.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-slate-400">
                <a href={`tel:${siteContent.brand.phone.replace(/\s/g, '')}`} className="flex items-center gap-2 hover:text-white transition">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  {siteContent.brand.phone}
                </a>
                <a href={`mailto:${siteContent.brand.email}`} className="flex items-center gap-2 hover:text-white transition">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <section className="py-16">
          <div className="container-page max-w-6xl">
            <div className="grid gap-10 lg:grid-cols-2">
              <div>
                <h2 className="text-xl font-semibold mb-2">Book a 30-min discovery call</h2>
              ...
              <div>
                <h2 className="text-xl font-semibold mb-2">Or send a message</h2>
                <p className="text-sm text-slate-500 mb-6">
